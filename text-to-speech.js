...
export default async (req, res) => {
    ...
    // WARNING: This is for demonstration. Do NOT hardcode your API key in production.
    // Use environment variables on Vercel instead for security.
    const GOOGLE_API_KEY = "AIzaSyDNOWRx8qxRw9Ecp_Q3Muqx8fZknlLEAHQ";
